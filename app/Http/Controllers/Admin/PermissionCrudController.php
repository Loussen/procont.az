...
class PermissionCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if(!backpack_user()->can('icazeler siyahi')){
            CRUD::denyAccess(['list']);
        }
        if(!backpack_user()->can('icazeler elave etmek')){
            CRUD::denyAccess(['create']);
        }
        if(!backpack_user()->can('icazeler duzelish etmek')){
            CRUD::denyAccess(['update']);
        }
        if(!backpack_user()->can('icazeler silmek')){
