...
class RoleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setEntityNameStrings('rol', 'rollar');
        $this->crud->setRoute(backpack_url('role'));

        // deny access according to configuration file
        if(!backpack_user()->can('rollar siyahi')){
            CRUD::denyAccess(['list']);
        }
        if(!backpack_user()->can('rollar elave etmek')){
            CRUD::denyAccess(['create']);
        }
        if(!backpack_user()->can('rollar duzelish etmek')){
            CRUD::denyAccess(['update']);
        }
        if(!backpack_user()->can('rollar silmek')){
