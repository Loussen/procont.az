...
<x-backpack::menu-item title="Products" icon="la la-hospital" :link="backpack_url('products')" />
{{--<x-backpack::menu-item :title="trans('backpack::crud.file_manager')" icon="la la-files-o" :link="backpack_url('elfinder')" />--}}
<x-backpack::menu-item title="Sliders" icon="la la-images" :link="backpack_url('sliders')" />
...
<x-backpack::menu-item title="Video gallery" icon="la la-video" :link="backpack_url('video-gallery')" />
